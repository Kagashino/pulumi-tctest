...
var DataSourceInfo = map[string]*tfbridge.DataSourceInfo{
	...
	"tencentcloud_vpc_instances":                            {Tok: tfbridge.MakeDataSource(mainPkg, "Vpc", "Instances")},
	...
	"tencentcloud_mysql_instance":                           {Tok: tfbridge.MakeDataSource(mainPkg, "Mysql", "Instance")},
	"tencentcloud_cos_bucket_object":                        {Tok: tfbridge.MakeDataSource(mainPkg, "Cos", "BucketObject")},
