...
var ResourceInfo = map[string]*tfbridge.ResourceInfo{
	...
	"tencentcloud_ccn_bandwidth_limit":                     {Tok: tfbridge.MakeResource(mainPkg, "Ccn","BandwidthLimit")},
	...
	"tencentcloud_ha_vip":                                  {Tok: tfbridge.MakeResource(mainPkg, "Ha","Vip")},
	...
	"tencentcloud_cos_bucket":                              {Tok: tfbridge.MakeResource(mainPkg, "Cos","Bucket")},
	...
	"tencentcloud_dayu_eip":                                {Tok: tfbridge.MakeResource(mainPkg, "Dayu","Eip")},
	...
	"tencentcloud_scf_namespace":                           {Tok: tfbridge.MakeResource(mainPkg, "Scf","Namespace")},
	...
	"tencentcloud_cdn_domain":                              {Tok: tfbridge.MakeResource(mainPkg, "Cdn","Domain")},
	...
	"tencentcloud_tcr_token":                               {Tok: tfbridge.MakeResource(mainPkg, "Tcr","Token")},
	...
	"tencentcloud_kms_key":                                 {Tok: tfbridge.MakeResource(mainPkg, "Kms","Key")},
	...
	"tencentcloud_private_dns_zone":                        {Tok: tfbridge.MakeResource(mainPkg, "Private","DnsZone")},
	"tencentcloud_private_dns_record":                      {Tok: tfbridge.MakeResource(mainPkg, "Private","DnsRecord")},
