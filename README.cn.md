...
本仓库包含从已有的 Terraform Provider 构建出新的 Pulumi provider 的样板代码。

### Background
本仓库属于 [授权与发布 Pulumi Package 指引](https://www.pulumi.com/docs/guides/pulumi-packages/how-to-author) 的一部分

了解 [Pulumi Packages](https://www.pulumi.com/docs/guides/pulumi-packages/#pulumi-packages).

## 创建 Pulumi Terraform Bridge Provider
