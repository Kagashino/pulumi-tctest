...
def api_gateway_customer_domains(result_output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tctest:Cloud/aPIGatewayCustomerDomains:APIGatewayCustomerDomains', __args__, opts=opts, typ=APIGatewayCustomerDomainsResult).value
