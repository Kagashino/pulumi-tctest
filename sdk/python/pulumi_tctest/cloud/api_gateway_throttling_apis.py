...
def api_gateway_throttling_apis(environment_names: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tctest:Cloud/aPIGatewayThrottlingApis:APIGatewayThrottlingApis', __args__, opts=opts, typ=APIGatewayThrottlingApisResult).value
