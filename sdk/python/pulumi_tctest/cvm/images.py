...
class ImagesResult:
    ...
    """
    def __init__(__self__, id=None, image_id=None, image_name_regex=None, image_types=None, images=None, os_name=None, result_output_file=None):
...
def images(image_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tctest:Cvm/images:Images', __args__, opts=opts, typ=ImagesResult).value
