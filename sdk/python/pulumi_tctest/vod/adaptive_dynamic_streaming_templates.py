...
def adaptive_dynamic_streaming_templates(definition: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tctest:Vod/adaptiveDynamicStreamingTemplates:AdaptiveDynamicStreamingTemplates', __args__, opts=opts, typ=AdaptiveDynamicStreamingTemplatesResult).value
