...
def snapshot_by_time_offset_templates(definition: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tctest:Vod/snapshotByTimeOffsetTemplates:SnapshotByTimeOffsetTemplates', __args__, opts=opts, typ=SnapshotByTimeOffsetTemplatesResult).value
