...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] redis_shard_num: The number of instance shard. This is not required for standalone and master slave versions.
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Instance, __self__).__init__(
            'tctest:Redis/instance:Instance',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="redisShardNum")
    def redis_shard_num(self) -> pulumi.Output[Optional[int]]:
        """
        The number of instance shard. This is not required for standalone and master slave versions.
        """
        return pulumi.get(self, "redis_shard_num")
    ...
    @property
    @pulumi.getter(name="replicasReadOnly")
    def replicas_read_only(self) -> pulumi.Output[Optional[bool]]:
        """
        Whether copy read-only is supported, Redis 2.8 Standard Edition and CKV Standard Edition do not support replica
        read-only, turn on replica read-only, the instance will automatically read and write separate, write requests are routed
        to the primary node, read requests are routed to the replica node, if you need to open replica read-only, the
