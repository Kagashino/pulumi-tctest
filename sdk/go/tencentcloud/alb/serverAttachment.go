...
func NewServerAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tencentcloud:Alb/serverAttachment:ServerAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerAttachment(ctx *pulumi.Context,
	...
	var resource ServerAttachment
	err := ctx.ReadResource("tencentcloud:Alb/serverAttachment:ServerAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
