...
func NewListener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/listener:Listener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetListener(ctx *pulumi.Context,
	...
	var resource Listener
	err := ctx.ReadResource("tctest:Clb/listener:Listener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
