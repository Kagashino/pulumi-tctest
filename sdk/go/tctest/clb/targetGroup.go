...
func NewTargetGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/targetGroup:TargetGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetGroup(ctx *pulumi.Context,
	...
	var resource TargetGroup
	err := ctx.ReadResource("tctest:Clb/targetGroup:TargetGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
