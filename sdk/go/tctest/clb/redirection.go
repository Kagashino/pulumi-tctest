...
func NewRedirection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/redirection:Redirection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedirection(ctx *pulumi.Context,
	...
	var resource Redirection
	err := ctx.ReadResource("tctest:Clb/redirection:Redirection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
