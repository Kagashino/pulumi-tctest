...
func NewTGAttachmentInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/tGAttachmentInstance:TGAttachmentInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTGAttachmentInstance(ctx *pulumi.Context,
	...
	var resource TGAttachmentInstance
	err := ctx.ReadResource("tctest:Clb/tGAttachmentInstance:TGAttachmentInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
