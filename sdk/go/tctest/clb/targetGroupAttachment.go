...
func NewTargetGroupAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/targetGroupAttachment:TargetGroupAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetGroupAttachment(ctx *pulumi.Context,
	...
	var resource TargetGroupAttachment
	err := ctx.ReadResource("tctest:Clb/targetGroupAttachment:TargetGroupAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
