...
func NewLogTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/logTopic:LogTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogTopic(ctx *pulumi.Context,
	...
	var resource LogTopic
	err := ctx.ReadResource("tctest:Clb/logTopic:LogTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
