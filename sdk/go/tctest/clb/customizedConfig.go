...
func NewCustomizedConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/customizedConfig:CustomizedConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomizedConfig(ctx *pulumi.Context,
	...
	var resource CustomizedConfig
	err := ctx.ReadResource("tctest:Clb/customizedConfig:CustomizedConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
