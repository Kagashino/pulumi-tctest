...
func (o ServerAttachmentTargetOutput) InstanceId() pulumi.StringOutput {
	return o.ApplyT(func(v ServerAttachmentTarget) string { return v.InstanceId }).(pulumi.StringOutput)
}
