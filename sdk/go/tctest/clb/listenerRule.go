...
func NewListenerRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Clb/listenerRule:ListenerRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetListenerRule(ctx *pulumi.Context,
	...
	var resource ListenerRule
	err := ctx.ReadResource("tctest:Clb/listenerRule:ListenerRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
