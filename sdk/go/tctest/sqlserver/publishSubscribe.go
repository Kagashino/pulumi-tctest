...
func NewPublishSubscribe(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Sqlserver/publishSubscribe:PublishSubscribe", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublishSubscribe(ctx *pulumi.Context,
	...
	var resource PublishSubscribe
	err := ctx.ReadResource("tctest:Sqlserver/publishSubscribe:PublishSubscribe", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
