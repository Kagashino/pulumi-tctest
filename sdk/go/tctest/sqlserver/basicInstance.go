...
func NewBasicInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Sqlserver/basicInstance:BasicInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBasicInstance(ctx *pulumi.Context,
	...
	var resource BasicInstance
	err := ctx.ReadResource("tctest:Sqlserver/basicInstance:BasicInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
