...
func NewAccountDBAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Sqlserver/accountDBAttachment:AccountDBAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountDBAttachment(ctx *pulumi.Context,
	...
	var resource AccountDBAttachment
	err := ctx.ReadResource("tctest:Sqlserver/accountDBAttachment:AccountDBAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
