...
func NewGatewaySnat(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Nat/gatewaySnat:GatewaySnat", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewaySnat(ctx *pulumi.Context,
	...
	var resource GatewaySnat
	err := ctx.ReadResource("tctest:Nat/gatewaySnat:GatewaySnat", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
