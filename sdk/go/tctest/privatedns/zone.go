...
func NewZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.RegisterResource("tctest:PrivateDns/zone:Zone", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetZone(ctx *pulumi.Context,
	...
	var resource Zone
	err := ctx.ReadResource("tctest:PrivateDns/zone:Zone", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
