...
func NewGroupMembership(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cam/groupMembership:GroupMembership", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupMembership(ctx *pulumi.Context,
	...
	var resource GroupMembership
	err := ctx.ReadResource("tctest:Cam/groupMembership:GroupMembership", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
