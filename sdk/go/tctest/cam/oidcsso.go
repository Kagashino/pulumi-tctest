...
func NewOIDCSSO(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cam/oIDCSSO:OIDCSSO", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOIDCSSO(ctx *pulumi.Context,
	...
	var resource OIDCSSO
	err := ctx.ReadResource("tctest:Cam/oIDCSSO:OIDCSSO", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
