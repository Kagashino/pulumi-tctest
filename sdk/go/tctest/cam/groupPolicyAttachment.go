...
func NewGroupPolicyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cam/groupPolicyAttachment:GroupPolicyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupPolicyAttachment(ctx *pulumi.Context,
	...
	var resource GroupPolicyAttachment
	err := ctx.ReadResource("tctest:Cam/groupPolicyAttachment:GroupPolicyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
