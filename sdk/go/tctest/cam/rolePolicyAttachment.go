...
func NewRolePolicyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cam/rolePolicyAttachment:RolePolicyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRolePolicyAttachment(ctx *pulumi.Context,
	...
	var resource RolePolicyAttachment
	err := ctx.ReadResource("tctest:Cam/rolePolicyAttachment:RolePolicyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
