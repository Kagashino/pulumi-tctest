...
func NewRoleSSO(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cam/roleSSO:RoleSSO", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleSSO(ctx *pulumi.Context,
	...
	var resource RoleSSO
	err := ctx.ReadResource("tctest:Cam/roleSSO:RoleSSO", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
