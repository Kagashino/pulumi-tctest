...
func NewSAMLProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cam/sAMLProvider:SAMLProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSAMLProvider(ctx *pulumi.Context,
	...
	var resource SAMLProvider
	err := ctx.ReadResource("tctest:Cam/sAMLProvider:SAMLProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
