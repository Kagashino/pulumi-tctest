...
func NewTemplateGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Protocol/templateGroup:TemplateGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplateGroup(ctx *pulumi.Context,
	...
	var resource TemplateGroup
	err := ctx.ReadResource("tctest:Protocol/templateGroup:TemplateGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
