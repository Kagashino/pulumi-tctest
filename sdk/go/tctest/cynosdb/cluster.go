...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cynosdb/cluster:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("tctest:Cynosdb/cluster:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
