...
func NewFileSystem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cfs/fileSystem:FileSystem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileSystem(ctx *pulumi.Context,
	...
	var resource FileSystem
	err := ctx.ReadResource("tctest:Cfs/fileSystem:FileSystem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
