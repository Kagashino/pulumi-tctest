...
func NewAccessRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cfs/accessRule:AccessRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessRule(ctx *pulumi.Context,
	...
	var resource AccessRule
	err := ctx.ReadResource("tctest:Cfs/accessRule:AccessRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
