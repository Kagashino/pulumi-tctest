...
func NewAccessGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cfs/accessGroup:AccessGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessGroup(ctx *pulumi.Context,
	...
	var resource AccessGroup
	err := ctx.ReadResource("tctest:Cfs/accessGroup:AccessGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
