...
func NewNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tdmq/namespace:Namespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespace(ctx *pulumi.Context,
	...
	var resource Namespace
	err := ctx.ReadResource("tctest:Tdmq/namespace:Namespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
