...
func NewNamespaceRoleAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tdmq/namespaceRoleAttachment:NamespaceRoleAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNamespaceRoleAttachment(ctx *pulumi.Context,
	...
	var resource NamespaceRoleAttachment
	err := ctx.ReadResource("tctest:Tdmq/namespaceRoleAttachment:NamespaceRoleAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
