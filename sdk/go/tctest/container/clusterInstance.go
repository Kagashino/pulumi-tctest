...
func NewClusterInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Container/clusterInstance:ClusterInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterInstance(ctx *pulumi.Context,
	...
	var resource ClusterInstance
	err := ctx.ReadResource("tctest:Container/clusterInstance:ClusterInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
