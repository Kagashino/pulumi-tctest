...
func NewTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Address/template:Template", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTemplate(ctx *pulumi.Context,
	...
	var resource Template
	err := ctx.ReadResource("tctest:Address/template:Template", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
