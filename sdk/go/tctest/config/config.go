...
func GetRegion(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "tctest:region")
	if err == nil {
		return v
	}
...
func GetSecretId(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "tctest:secretId")
	if err == nil {
		return v
	}
...
func GetSecretKey(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "tctest:secretKey")
	if err == nil {
		return v
	}
...
func GetSecurityToken(ctx *pulumi.Context) string {
	v, err := config.Try(ctx, "tctest:securityToken")
	if err == nil {
		return v
	}
