...
func NewSnapshotPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cbs/snapshotPolicy:SnapshotPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotPolicy(ctx *pulumi.Context,
	...
	var resource SnapshotPolicy
	err := ctx.ReadResource("tctest:Cbs/snapshotPolicy:SnapshotPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
