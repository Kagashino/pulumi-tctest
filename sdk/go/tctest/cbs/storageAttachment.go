...
func NewStorageAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cbs/storageAttachment:StorageAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageAttachment(ctx *pulumi.Context,
	...
	var resource StorageAttachment
	err := ctx.ReadResource("tctest:Cbs/storageAttachment:StorageAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
