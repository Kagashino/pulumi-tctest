...
func NewStorage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cbs/storage:Storage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorage(ctx *pulumi.Context,
	...
	var resource Storage
	err := ctx.ReadResource("tctest:Cbs/storage:Storage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
