...
func NewSnapshotPolicyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cbs/snapshotPolicyAttachment:SnapshotPolicyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotPolicyAttachment(ctx *pulumi.Context,
	...
	var resource SnapshotPolicyAttachment
	err := ctx.ReadResource("tctest:Cbs/snapshotPolicyAttachment:SnapshotPolicyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
