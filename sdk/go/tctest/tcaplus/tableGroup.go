...
func NewTableGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tcaplus/tableGroup:TableGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableGroup(ctx *pulumi.Context,
	...
	var resource TableGroup
	err := ctx.ReadResource("tctest:Tcaplus/tableGroup:TableGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
