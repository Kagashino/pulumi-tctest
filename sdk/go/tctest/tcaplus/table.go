...
func NewTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.RegisterResource("tctest:Tcaplus/table:Table", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTable(ctx *pulumi.Context,
	...
	var resource Table
	err := ctx.ReadResource("tctest:Tcaplus/table:Table", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
