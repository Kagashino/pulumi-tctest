...
func NewAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Eni/attachment:Attachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachment(ctx *pulumi.Context,
	...
	var resource Attachment
	err := ctx.ReadResource("tctest:Eni/attachment:Attachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
