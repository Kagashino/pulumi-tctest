...
func NewReservedInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cvm/reservedInstance:ReservedInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReservedInstance(ctx *pulumi.Context,
	...
	var resource ReservedInstance
	err := ctx.ReadResource("tctest:Cvm/reservedInstance:ReservedInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
