...
func NewDomainInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dnspod/domainInstance:DomainInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainInstance(ctx *pulumi.Context,
	...
	var resource DomainInstance
	err := ctx.ReadResource("tctest:Dnspod/domainInstance:DomainInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
