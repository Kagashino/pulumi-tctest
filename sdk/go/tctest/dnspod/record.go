...
func NewRecord(ctx *pulumi.Context,
	...
	var resource Record
	err := ctx.RegisterResource("tctest:Dnspod/record:Record", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRecord(ctx *pulumi.Context,
	...
	var resource Record
	err := ctx.ReadResource("tctest:Dnspod/record:Record", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
