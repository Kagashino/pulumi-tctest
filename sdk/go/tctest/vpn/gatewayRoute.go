...
func NewGatewayRoute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vpn/gatewayRoute:GatewayRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayRoute(ctx *pulumi.Context,
	...
	var resource GatewayRoute
	err := ctx.ReadResource("tctest:Vpn/gatewayRoute:GatewayRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
