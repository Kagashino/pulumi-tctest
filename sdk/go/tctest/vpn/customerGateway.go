...
func NewCustomerGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vpn/customerGateway:CustomerGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomerGateway(ctx *pulumi.Context,
	...
	var resource CustomerGateway
	err := ctx.ReadResource("tctest:Vpn/customerGateway:CustomerGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
