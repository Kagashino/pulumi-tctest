...
func NewSslClient(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vpn/sslClient:SslClient", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslClient(ctx *pulumi.Context,
	...
	var resource SslClient
	err := ctx.ReadResource("tctest:Vpn/sslClient:SslClient", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
