...
func NewSslServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vpn/sslServer:SslServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslServer(ctx *pulumi.Context,
	...
	var resource SslServer
	err := ctx.ReadResource("tctest:Vpn/sslServer:SslServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
