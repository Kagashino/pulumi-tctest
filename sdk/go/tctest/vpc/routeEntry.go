...
func NewRouteEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vpc/routeEntry:RouteEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteEntry(ctx *pulumi.Context,
	...
	var resource RouteEntry
	err := ctx.ReadResource("tctest:Vpc/routeEntry:RouteEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
