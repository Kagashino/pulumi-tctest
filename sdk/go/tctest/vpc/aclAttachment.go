...
func NewAclAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vpc/aclAttachment:AclAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAclAttachment(ctx *pulumi.Context,
	...
	var resource AclAttachment
	err := ctx.ReadResource("tctest:Vpc/aclAttachment:AclAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
