...
func NewSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:As/schedule:Schedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchedule(ctx *pulumi.Context,
	...
	var resource Schedule
	err := ctx.ReadResource("tctest:As/schedule:Schedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
