...
func NewScalingConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:As/scalingConfig:ScalingConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingConfig(ctx *pulumi.Context,
	...
	var resource ScalingConfig
	err := ctx.ReadResource("tctest:As/scalingConfig:ScalingConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
