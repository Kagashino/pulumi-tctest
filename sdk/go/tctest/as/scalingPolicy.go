...
func NewScalingPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:As/scalingPolicy:ScalingPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingPolicy(ctx *pulumi.Context,
	...
	var resource ScalingPolicy
	err := ctx.ReadResource("tctest:As/scalingPolicy:ScalingPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
