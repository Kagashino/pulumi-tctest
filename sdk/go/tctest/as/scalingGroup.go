...
func NewScalingGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:As/scalingGroup:ScalingGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingGroup(ctx *pulumi.Context,
	...
	var resource ScalingGroup
	err := ctx.ReadResource("tctest:As/scalingGroup:ScalingGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
