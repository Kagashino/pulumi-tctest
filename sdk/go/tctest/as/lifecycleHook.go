...
func NewLifecycleHook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:As/lifecycleHook:LifecycleHook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLifecycleHook(ctx *pulumi.Context,
	...
	var resource LifecycleHook
	err := ctx.ReadResource("tctest:As/lifecycleHook:LifecycleHook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
