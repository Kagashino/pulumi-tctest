...
func NewNotification(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:As/notification:Notification", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotification(ctx *pulumi.Context,
	...
	var resource Notification
	err := ctx.ReadResource("tctest:As/notification:Notification", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
