...
func NewUsagePlanAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:APIGateway/usagePlanAttachment:UsagePlanAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUsagePlanAttachment(ctx *pulumi.Context,
	...
	var resource UsagePlanAttachment
	err := ctx.ReadResource("tctest:APIGateway/usagePlanAttachment:UsagePlanAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
