...
func NewAPIKey(ctx *pulumi.Context,
	...
	var resource APIKey
	err := ctx.RegisterResource("tctest:APIGateway/aPIKey:APIKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAPIKey(ctx *pulumi.Context,
	...
	var resource APIKey
	err := ctx.ReadResource("tctest:APIGateway/aPIKey:APIKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
