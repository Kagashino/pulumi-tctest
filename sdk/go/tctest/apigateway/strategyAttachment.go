...
func NewStrategyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:APIGateway/strategyAttachment:StrategyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStrategyAttachment(ctx *pulumi.Context,
	...
	var resource StrategyAttachment
	err := ctx.ReadResource("tctest:APIGateway/strategyAttachment:StrategyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
