...
func NewIPStrategy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:APIGateway/iPStrategy:IPStrategy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIPStrategy(ctx *pulumi.Context,
	...
	var resource IPStrategy
	err := ctx.ReadResource("tctest:APIGateway/iPStrategy:IPStrategy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
