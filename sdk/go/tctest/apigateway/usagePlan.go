...
func NewUsagePlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:APIGateway/usagePlan:UsagePlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUsagePlan(ctx *pulumi.Context,
	...
	var resource UsagePlan
	err := ctx.ReadResource("tctest:APIGateway/usagePlan:UsagePlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
