...
func NewCustomDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:APIGateway/customDomain:CustomDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomDomain(ctx *pulumi.Context,
	...
	var resource CustomDomain
	err := ctx.ReadResource("tctest:APIGateway/customDomain:CustomDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
