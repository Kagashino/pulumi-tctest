...
func NewServiceRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:APIGateway/serviceRelease:ServiceRelease", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRelease(ctx *pulumi.Context,
	...
	var resource ServiceRelease
	err := ctx.ReadResource("tctest:APIGateway/serviceRelease:ServiceRelease", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
