...
func NewSecretVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Ssm/secretVersion:SecretVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretVersion(ctx *pulumi.Context,
	...
	var resource SecretVersion
	err := ctx.ReadResource("tctest:Ssm/secretVersion:SecretVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
