...
func NewReadonlyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Postgresql/readonlyAttachment:ReadonlyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadonlyAttachment(ctx *pulumi.Context,
	...
	var resource ReadonlyAttachment
	err := ctx.ReadResource("tctest:Postgresql/readonlyAttachment:ReadonlyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
