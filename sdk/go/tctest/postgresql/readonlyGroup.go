...
func NewReadonlyGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Postgresql/readonlyGroup:ReadonlyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadonlyGroup(ctx *pulumi.Context,
	...
	var resource ReadonlyGroup
	err := ctx.ReadResource("tctest:Postgresql/readonlyGroup:ReadonlyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
