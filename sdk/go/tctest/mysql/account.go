...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mysql/account:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("tctest:Mysql/account:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
