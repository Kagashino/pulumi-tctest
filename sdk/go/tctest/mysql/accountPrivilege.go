...
func NewAccountPrivilege(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mysql/accountPrivilege:AccountPrivilege", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountPrivilege(ctx *pulumi.Context,
	...
	var resource AccountPrivilege
	err := ctx.ReadResource("tctest:Mysql/accountPrivilege:AccountPrivilege", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
