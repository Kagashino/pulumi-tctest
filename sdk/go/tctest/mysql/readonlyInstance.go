...
func NewReadonlyInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mysql/readonlyInstance:ReadonlyInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReadonlyInstance(ctx *pulumi.Context,
	...
	var resource ReadonlyInstance
	err := ctx.ReadResource("tctest:Mysql/readonlyInstance:ReadonlyInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
