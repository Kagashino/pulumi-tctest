...
func NewPrivilege(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mysql/privilege:Privilege", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivilege(ctx *pulumi.Context,
	...
	var resource Privilege
	err := ctx.ReadResource("tctest:Mysql/privilege:Privilege", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
