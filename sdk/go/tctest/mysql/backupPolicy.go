...
func NewBackupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mysql/backupPolicy:BackupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupPolicy(ctx *pulumi.Context,
	...
	var resource BackupPolicy
	err := ctx.ReadResource("tctest:Mysql/backupPolicy:BackupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
