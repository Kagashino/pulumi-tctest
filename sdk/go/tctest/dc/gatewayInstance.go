...
func NewGatewayInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dc/gatewayInstance:GatewayInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayInstance(ctx *pulumi.Context,
	...
	var resource GatewayInstance
	err := ctx.ReadResource("tctest:Dc/gatewayInstance:GatewayInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
