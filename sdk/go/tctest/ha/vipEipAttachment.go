...
func NewVipEipAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Ha/vipEipAttachment:VipEipAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVipEipAttachment(ctx *pulumi.Context,
	...
	var resource VipEipAttachment
	err := ctx.ReadResource("tctest:Ha/vipEipAttachment:VipEipAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
