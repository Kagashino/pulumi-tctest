...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Eip/instance:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("tctest:Eip/instance:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
