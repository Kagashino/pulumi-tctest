...
func NewAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Eip/association:Association", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssociation(ctx *pulumi.Context,
	...
	var resource Association
	err := ctx.ReadResource("tctest:Eip/association:Association", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
