...
func NewContainerInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Eks/containerInstance:ContainerInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerInstance(ctx *pulumi.Context,
	...
	var resource ContainerInstance
	err := ctx.ReadResource("tctest:Eks/containerInstance:ContainerInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
