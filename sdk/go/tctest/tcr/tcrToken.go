...
func NewTcrToken(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tcr/tcrToken:TcrToken", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTcrToken(ctx *pulumi.Context,
	...
	var resource TcrToken
	err := ctx.ReadResource("tctest:Tcr/tcrToken:TcrToken", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
