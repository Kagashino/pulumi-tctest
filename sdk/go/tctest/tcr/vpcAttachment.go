...
func NewVpcAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tcr/vpcAttachment:VpcAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcAttachment(ctx *pulumi.Context,
	...
	var resource VpcAttachment
	err := ctx.ReadResource("tctest:Tcr/vpcAttachment:VpcAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
