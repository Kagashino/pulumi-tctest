...
func NewBackupConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Redis/backupConfig:BackupConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupConfig(ctx *pulumi.Context,
	...
	var resource BackupConfig
	err := ctx.ReadResource("tctest:Redis/backupConfig:BackupConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
