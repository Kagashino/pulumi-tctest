...
func NewProcedureTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vod/procedureTemplate:ProcedureTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProcedureTemplate(ctx *pulumi.Context,
	...
	var resource ProcedureTemplate
	err := ctx.ReadResource("tctest:Vod/procedureTemplate:ProcedureTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
