...
func NewImageSpriteTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vod/imageSpriteTemplate:ImageSpriteTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImageSpriteTemplate(ctx *pulumi.Context,
	...
	var resource ImageSpriteTemplate
	err := ctx.ReadResource("tctest:Vod/imageSpriteTemplate:ImageSpriteTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
