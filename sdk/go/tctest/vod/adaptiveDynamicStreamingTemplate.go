...
func NewAdaptiveDynamicStreamingTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vod/adaptiveDynamicStreamingTemplate:AdaptiveDynamicStreamingTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAdaptiveDynamicStreamingTemplate(ctx *pulumi.Context,
	...
	var resource AdaptiveDynamicStreamingTemplate
	err := ctx.ReadResource("tctest:Vod/adaptiveDynamicStreamingTemplate:AdaptiveDynamicStreamingTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
