...
func NewSuperPlayerConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vod/superPlayerConfig:SuperPlayerConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSuperPlayerConfig(ctx *pulumi.Context,
	...
	var resource SuperPlayerConfig
	err := ctx.ReadResource("tctest:Vod/superPlayerConfig:SuperPlayerConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
