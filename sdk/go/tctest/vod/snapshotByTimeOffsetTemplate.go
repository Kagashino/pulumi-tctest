...
func NewSnapshotByTimeOffsetTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Vod/snapshotByTimeOffsetTemplate:SnapshotByTimeOffsetTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotByTimeOffsetTemplate(ctx *pulumi.Context,
	...
	var resource SnapshotByTimeOffsetTemplate
	err := ctx.ReadResource("tctest:Vod/snapshotByTimeOffsetTemplate:SnapshotByTimeOffsetTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
