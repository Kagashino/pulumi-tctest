...
func NewShardingInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mongodb/shardingInstance:ShardingInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShardingInstance(ctx *pulumi.Context,
	...
	var resource ShardingInstance
	err := ctx.ReadResource("tctest:Mongodb/shardingInstance:ShardingInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
