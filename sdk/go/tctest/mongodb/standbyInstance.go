...
func NewStandbyInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Mongodb/standbyInstance:StandbyInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStandbyInstance(ctx *pulumi.Context,
	...
	var resource StandbyInstance
	err := ctx.ReadResource("tctest:Mongodb/standbyInstance:StandbyInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
