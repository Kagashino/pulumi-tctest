...
func NewAuthAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tke/authAttachment:AuthAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthAttachment(ctx *pulumi.Context,
	...
	var resource AuthAttachment
	err := ctx.ReadResource("tctest:Tke/authAttachment:AuthAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
