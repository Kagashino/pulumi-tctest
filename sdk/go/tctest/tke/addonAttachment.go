...
func NewAddonAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tke/addonAttachment:AddonAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddonAttachment(ctx *pulumi.Context,
	...
	var resource AddonAttachment
	err := ctx.ReadResource("tctest:Tke/addonAttachment:AddonAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
