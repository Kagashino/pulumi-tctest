...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tke/cluster:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("tctest:Tke/cluster:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ClusterOutput) ClusterLevel() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringPtrOutput { return v.ClusterLevel }).(pulumi.StringPtrOutput)
}
