...
func NewAsScalingGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tke/asScalingGroup:AsScalingGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAsScalingGroup(ctx *pulumi.Context,
	...
	var resource AsScalingGroup
	err := ctx.ReadResource("tctest:Tke/asScalingGroup:AsScalingGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
