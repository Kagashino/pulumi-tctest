...
func NewNodePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tke/nodePool:NodePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodePool(ctx *pulumi.Context,
	...
	var resource NodePool
	err := ctx.ReadResource("tctest:Tke/nodePool:NodePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
