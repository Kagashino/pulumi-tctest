...
func NewClusterAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Tke/clusterAttachment:ClusterAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterAttachment(ctx *pulumi.Context,
	...
	var resource ClusterAttachment
	err := ctx.ReadResource("tctest:Tke/clusterAttachment:ClusterAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
