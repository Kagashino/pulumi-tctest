...
func NewBindingObject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Monitor/bindingObject:BindingObject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBindingObject(ctx *pulumi.Context,
	...
	var resource BindingObject
	err := ctx.ReadResource("tctest:Monitor/bindingObject:BindingObject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
