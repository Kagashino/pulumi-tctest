...
func NewAlarmPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Monitor/alarmPolicy:AlarmPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlarmPolicy(ctx *pulumi.Context,
	...
	var resource AlarmPolicy
	err := ctx.ReadResource("tctest:Monitor/alarmPolicy:AlarmPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
