...
func NewPolicyBindingObject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Monitor/policyBindingObject:PolicyBindingObject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyBindingObject(ctx *pulumi.Context,
	...
	var resource PolicyBindingObject
	err := ctx.ReadResource("tctest:Monitor/policyBindingObject:PolicyBindingObject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
