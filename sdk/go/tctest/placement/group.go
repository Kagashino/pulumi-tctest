...
func NewGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.RegisterResource("tctest:Placement/group:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("tctest:Placement/group:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
