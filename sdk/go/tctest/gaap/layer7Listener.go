...
func NewLayer7Listener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/layer7Listener:Layer7Listener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLayer7Listener(ctx *pulumi.Context,
	...
	var resource Layer7Listener
	err := ctx.ReadResource("tctest:Gaap/layer7Listener:Layer7Listener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
