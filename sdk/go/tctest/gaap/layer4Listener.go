...
func NewLayer4Listener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/layer4Listener:Layer4Listener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLayer4Listener(ctx *pulumi.Context,
	...
	var resource Layer4Listener
	err := ctx.ReadResource("tctest:Gaap/layer4Listener:Layer4Listener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
