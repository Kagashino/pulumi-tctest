...
func NewHttpDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/httpDomain:HttpDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpDomain(ctx *pulumi.Context,
	...
	var resource HttpDomain
	err := ctx.ReadResource("tctest:Gaap/httpDomain:HttpDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
