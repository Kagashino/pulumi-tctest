...
func NewDomainErrorPageInfo(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/domainErrorPageInfo:DomainErrorPageInfo", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomainErrorPageInfo(ctx *pulumi.Context,
	...
	var resource DomainErrorPageInfo
	err := ctx.ReadResource("tctest:Gaap/domainErrorPageInfo:DomainErrorPageInfo", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
