...
func NewCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/certificate:Certificate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificate(ctx *pulumi.Context,
	...
	var resource Certificate
	err := ctx.ReadResource("tctest:Gaap/certificate:Certificate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
