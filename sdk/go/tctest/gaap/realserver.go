...
func NewRealserver(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/realserver:Realserver", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRealserver(ctx *pulumi.Context,
	...
	var resource Realserver
	err := ctx.ReadResource("tctest:Gaap/realserver:Realserver", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
