...
func NewSecurityPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/securityPolicy:SecurityPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityPolicy(ctx *pulumi.Context,
	...
	var resource SecurityPolicy
	err := ctx.ReadResource("tctest:Gaap/securityPolicy:SecurityPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
