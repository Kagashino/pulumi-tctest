...
func NewHttpRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Gaap/httpRule:HttpRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHttpRule(ctx *pulumi.Context,
	...
	var resource HttpRule
	err := ctx.ReadResource("tctest:Gaap/httpRule:HttpRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
