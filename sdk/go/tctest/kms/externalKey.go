...
func NewExternalKey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Kms/externalKey:ExternalKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExternalKey(ctx *pulumi.Context,
	...
	var resource ExternalKey
	err := ctx.ReadResource("tctest:Kms/externalKey:ExternalKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
