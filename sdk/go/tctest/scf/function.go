...
func NewFunction(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Scf/function:Function", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFunction(ctx *pulumi.Context,
	...
	var resource Function
	err := ctx.ReadResource("tctest:Scf/function:Function", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
