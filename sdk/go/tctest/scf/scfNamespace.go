...
func NewScfNamespace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Scf/scfNamespace:ScfNamespace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScfNamespace(ctx *pulumi.Context,
	...
	var resource ScfNamespace
	err := ctx.ReadResource("tctest:Scf/scfNamespace:ScfNamespace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
