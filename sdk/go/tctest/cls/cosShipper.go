...
func NewCosShipper(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cls/cosShipper:CosShipper", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCosShipper(ctx *pulumi.Context,
	...
	var resource CosShipper
	err := ctx.ReadResource("tctest:Cls/cosShipper:CosShipper", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
