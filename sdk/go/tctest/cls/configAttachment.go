...
func NewConfigAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cls/configAttachment:ConfigAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigAttachment(ctx *pulumi.Context,
	...
	var resource ConfigAttachment
	err := ctx.ReadResource("tctest:Cls/configAttachment:ConfigAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
