...
func NewCcnBandwidthLimit(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Ccn/ccnBandwidthLimit:CcnBandwidthLimit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCcnBandwidthLimit(ctx *pulumi.Context,
	...
	var resource CcnBandwidthLimit
	err := ctx.ReadResource("tctest:Ccn/ccnBandwidthLimit:CcnBandwidthLimit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
