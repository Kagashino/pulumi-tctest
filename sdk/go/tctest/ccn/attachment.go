...
func NewAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Ccn/attachment:Attachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachment(ctx *pulumi.Context,
	...
	var resource Attachment
	err := ctx.ReadResource("tctest:Ccn/attachment:Attachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
