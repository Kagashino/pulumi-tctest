...
func NewCosBucket(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cos/cosBucket:CosBucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCosBucket(ctx *pulumi.Context,
	...
	var resource CosBucket
	err := ctx.ReadResource("tctest:Cos/cosBucket:CosBucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
