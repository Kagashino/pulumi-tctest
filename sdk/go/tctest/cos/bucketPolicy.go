...
func NewBucketPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cos/bucketPolicy:BucketPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketPolicy(ctx *pulumi.Context,
	...
	var resource BucketPolicy
	err := ctx.ReadResource("tctest:Cos/bucketPolicy:BucketPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
