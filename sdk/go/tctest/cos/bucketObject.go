...
func NewBucketObject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Cos/bucketObject:BucketObject", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketObject(ctx *pulumi.Context,
	...
	var resource BucketObject
	err := ctx.ReadResource("tctest:Cos/bucketObject:BucketObject", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
