...
func NewGroupLiteRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Security/groupLiteRule:GroupLiteRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupLiteRule(ctx *pulumi.Context,
	...
	var resource GroupLiteRule
	err := ctx.ReadResource("tctest:Security/groupLiteRule:GroupLiteRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
