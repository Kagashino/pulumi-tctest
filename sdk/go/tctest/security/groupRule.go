...
func NewGroupRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Security/groupRule:GroupRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupRule(ctx *pulumi.Context,
	...
	var resource GroupRule
	err := ctx.ReadResource("tctest:Security/groupRule:GroupRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
