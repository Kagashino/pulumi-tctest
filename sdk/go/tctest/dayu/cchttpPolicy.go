...
func NewCCHttpPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/cCHttpPolicy:CCHttpPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCCHttpPolicy(ctx *pulumi.Context,
	...
	var resource CCHttpPolicy
	err := ctx.ReadResource("tctest:Dayu/cCHttpPolicy:CCHttpPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
