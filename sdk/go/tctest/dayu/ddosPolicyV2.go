...
func NewDdosPolicyV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/ddosPolicyV2:DdosPolicyV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosPolicyV2(ctx *pulumi.Context,
	...
	var resource DdosPolicyV2
	err := ctx.ReadResource("tctest:Dayu/ddosPolicyV2:DdosPolicyV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
