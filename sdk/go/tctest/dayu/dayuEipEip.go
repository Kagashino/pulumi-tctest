...
func NewDayuEipEip(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/dayuEipEip:DayuEipEip", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDayuEipEip(ctx *pulumi.Context,
	...
	var resource DayuEipEip
	err := ctx.ReadResource("tctest:Dayu/dayuEipEip:DayuEipEip", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
