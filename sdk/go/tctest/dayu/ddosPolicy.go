...
func NewDdosPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/ddosPolicy:DdosPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosPolicy(ctx *pulumi.Context,
	...
	var resource DdosPolicy
	err := ctx.ReadResource("tctest:Dayu/ddosPolicy:DdosPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
