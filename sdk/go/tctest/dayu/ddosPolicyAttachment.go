...
func NewDdosPolicyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/ddosPolicyAttachment:DdosPolicyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosPolicyAttachment(ctx *pulumi.Context,
	...
	var resource DdosPolicyAttachment
	err := ctx.ReadResource("tctest:Dayu/ddosPolicyAttachment:DdosPolicyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
