...
func NewDdosPolicyCase(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/ddosPolicyCase:DdosPolicyCase", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDdosPolicyCase(ctx *pulumi.Context,
	...
	var resource DdosPolicyCase
	err := ctx.ReadResource("tctest:Dayu/ddosPolicyCase:DdosPolicyCase", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
