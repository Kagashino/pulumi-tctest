...
func NewL4RuleV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/l4RuleV2:L4RuleV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL4RuleV2(ctx *pulumi.Context,
	...
	var resource L4RuleV2
	err := ctx.ReadResource("tctest:Dayu/l4RuleV2:L4RuleV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
