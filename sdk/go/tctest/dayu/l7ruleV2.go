...
func NewL7RuleV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/l7RuleV2:L7RuleV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetL7RuleV2(ctx *pulumi.Context,
	...
	var resource L7RuleV2
	err := ctx.ReadResource("tctest:Dayu/l7RuleV2:L7RuleV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
