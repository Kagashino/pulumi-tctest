...
func NewCCPolicyV2(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/cCPolicyV2:CCPolicyV2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCCPolicyV2(ctx *pulumi.Context,
	...
	var resource CCPolicyV2
	err := ctx.ReadResource("tctest:Dayu/cCPolicyV2:CCPolicyV2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
