...
func NewCCHttpsPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tctest:Dayu/cCHttpsPolicy:CCHttpsPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCCHttpsPolicy(ctx *pulumi.Context,
	...
	var resource CCHttpsPolicy
	err := ctx.ReadResource("tctest:Dayu/cCHttpsPolicy:CCHttpsPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
