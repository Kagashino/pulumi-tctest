...
namespace Pulumi.Tctest.Security
{
    public static class Groups
    {
        public static Task<GroupsResult> InvokeAsync(GroupsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GroupsResult>("tctest:Security/groups:Groups", args ?? new GroupsArgs(), options.WithDefaults());

        public static Output<GroupsResult> Invoke(GroupsInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GroupsResult>("tctest:Security/groups:Groups", args ?? new GroupsInvokeArgs(), options.WithDefaults());
    }
