...
namespace Pulumi.Tctest
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Tctest.version.txt");
    ...
    internal sealed class TctestResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public TctestResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
