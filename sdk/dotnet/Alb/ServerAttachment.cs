...
namespace Pulumi.Tencentcloud.Alb
{
    [TencentcloudResourceType("tencentcloud:Alb/serverAttachment:ServerAttachment")]
    public partial class ServerAttachment : Pulumi.CustomResource
    {
        ...
        public ServerAttachment(string name, ServerAttachmentArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Alb/serverAttachment:ServerAttachment", name, args ?? new ServerAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerAttachment(string name, Input<string> id, ServerAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Alb/serverAttachment:ServerAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
