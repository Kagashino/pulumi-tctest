...
{
    [TctestResourceType("tctest:Dayu/l4RuleV2:L4RuleV2")]
    public partial class L4RuleV2 : Pulumi.CustomResource
    {
        ...
        public L4RuleV2(string name, L4RuleV2Args args, CustomResourceOptions? options = null)
            : base("tctest:Dayu/l4RuleV2:L4RuleV2", name, args ?? new L4RuleV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private L4RuleV2(string name, Input<string> id, L4RuleV2State? state = null, CustomResourceOptions? options = null)
            : base("tctest:Dayu/l4RuleV2:L4RuleV2", name, state, MakeResourceOptions(options, id))
        {
        }
