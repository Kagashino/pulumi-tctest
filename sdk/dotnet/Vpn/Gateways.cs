...
namespace Pulumi.Tctest.Vpn
{
    public static class Gateways
    {
        public static Task<GatewaysResult> InvokeAsync(GatewaysArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GatewaysResult>("tctest:Vpn/gateways:Gateways", args ?? new GatewaysArgs(), options.WithDefaults());

        public static Output<GatewaysResult> Invoke(GatewaysInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GatewaysResult>("tctest:Vpn/gateways:Gateways", args ?? new GatewaysInvokeArgs(), options.WithDefaults());
    }
