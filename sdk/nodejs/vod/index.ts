...
pulumi.runtime.registerResourceModule("tctest", "Vod/adaptiveDynamicStreamingTemplate", _module)
pulumi.runtime.registerResourceModule("tctest", "Vod/imageSpriteTemplate", _module)
pulumi.runtime.registerResourceModule("tctest", "Vod/procedureTemplate", _module)
pulumi.runtime.registerResourceModule("tctest", "Vod/snapshotByTimeOffsetTemplate", _module)
pulumi.runtime.registerResourceModule("tctest", "Vod/subApplication", _module)
pulumi.runtime.registerResourceModule("tctest", "Vod/superPlayerConfig", _module)
