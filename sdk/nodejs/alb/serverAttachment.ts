...
export class ServerAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:Alb/serverAttachment:ServerAttachment';
     ...
     */
    public readonly backends!: pulumi.Output<outputs.Alb.ServerAttachmentBackend[]>;
    /**
     * listener ID.
     */
...
export interface ServerAttachmentState {
     ...
     * list of backend server.
     */
    backends?: pulumi.Input<pulumi.Input<inputs.Alb.ServerAttachmentBackend>[]>;
    /**
     * listener ID.
     */
